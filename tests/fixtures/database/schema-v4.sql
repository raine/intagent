...
CREATE TABLE triage_run_steps (
    ...
    started_at TEXT NOT NULL,
    ended_at TEXT,
    outcome TEXT, turn_id INTEGER REFERENCES triage_run_turns(id),
...
CREATE TABLE triage_runs (
  ...
  , termination_reason TEXT, failure_category TEXT, context_window INTEGER, max_tokens INTEGER, telemetry_version INTEGER, telemetry_completeness TEXT NOT NULL DEFAULT 'legacy');
...
INSERT INTO "entities" ("id", "source", "external_id", "kind", "title", "aven_ref", "investigation_handle", "last_event_at", "handling_status", "operational_metadata") VALUES (1, 'fastmail', 'github:example/intake#42', 'github-issue', 'Investigate delayed notifications', 'APP-7KQ9', 'inspect-notifications', '2026-08-07T09:59:59.999Z', 'retryable', '{"url":"https://github.example/example/intake/issues/42?token=removed#activity","kind":"github-issue"}');
...
INSERT INTO "triage_run_steps" ("id", "run_id", "step_key", "kind", "label", "started_at", "ended_at", "outcome", "turn_id") VALUES (1, 1, 'fixture-step-1', 'tool', 'bash', '2026-08-07T10:00:30.000Z', '2026-08-07T10:00:40.000Z', 'succeeded', 1);
INSERT INTO "triage_run_steps" ("id", "run_id", "step_key", "kind", "label", "started_at", "ended_at", "outcome", "turn_id") VALUES (2, 2, 'fixture-step-2', 'thinking', 'thinking', '2026-08-07T10:00:21.000Z', '2026-08-07T10:00:25.000Z', 'interrupted', NULL);
INSERT INTO "triage_run_steps" ("id", "run_id", "step_key", "kind", "label", "started_at", "ended_at", "outcome", "turn_id") VALUES (3, 1, 'fixture-step-3', 'thinking', 'thinking', '2026-08-07T10:00:10.000Z', '2026-08-07T10:00:25.000Z', 'succeeded', 1);
INSERT INTO "triage_run_steps" ("id", "run_id", "step_key", "kind", "label", "started_at", "ended_at", "outcome", "turn_id") VALUES (4, 1, 'fixture-step-4', 'compaction', 'compaction', '2026-08-07T10:01:20.000Z', '2026-08-07T10:01:50.000Z', 'succeeded', 1);
...
INSERT INTO "triage_runs" ("id", "event_id", "attempt", "started_at", "ended_at", "last_activity_at", "outcome", "model_id", "model_provider", "thinking_level", "turn_count", "retry_count", "compaction_count", "termination_reason", "failure_category", "context_window", "max_tokens", "telemetry_version", "telemetry_completeness") VALUES (1, 4, 1, '2026-08-07T10:00:00.000Z', '2026-08-07T10:03:00.000Z', '2026-08-07T10:03:00.000Z', 'succeeded', 'gpt-5.6-luna', 'openai-codex', 'max', 1, 1, 1, 'completed', NULL, 200000, 16000, 1, 'complete');
INSERT INTO "triage_runs" ("id", "event_id", "attempt", "started_at", "ended_at", "last_activity_at", "outcome", "model_id", "model_provider", "thinking_level", "turn_count", "retry_count", "compaction_count", "termination_reason", "failure_category", "context_window", "max_tokens", "telemetry_version", "telemetry_completeness") VALUES (2, 3, 2, '2026-08-07T10:00:20.000Z', '2026-08-07T10:00:25.000Z', '2026-08-07T10:00:25.000Z', 'interrupted', 'gpt-5.6-luna', 'openai-codex', 'high', 1, 0, 0, 'legacy_interruption', 'interrupted', NULL, NULL, NULL, 'legacy');
INSERT INTO "triage_runs" ("id", "event_id", "attempt", "started_at", "ended_at", "last_activity_at", "outcome", "model_id", "model_provider", "thinking_level", "turn_count", "retry_count", "compaction_count", "termination_reason", "failure_category", "context_window", "max_tokens", "telemetry_version", "telemetry_completeness") VALUES (3, 3, 3, '2026-08-07T10:04:00.000Z', '2026-08-07T10:04:30.000Z', '2026-08-07T10:04:30.000Z', 'failed', 'gpt-5.6-luna', 'openai-codex', 'high', 1, 0, 0, 'model_error', 'model_unavailable', 200000, 16000, 1, 'complete');
COMMIT;
