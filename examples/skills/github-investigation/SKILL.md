...
description:
  ...
  with an isolated investigation.
---

# GitHub investigation

Use the available workmux skill for command syntax.

1. Classify the decision-relevant content introduced by the current revision
   before searching workmux or projects. Earlier issue or pull request content
...
3. For substantive follow-up activity that warrants additional investigation,
   ...
   `/skill:investigate` again for the same activity. Include the most specific
   activity
...
4. Dispatch `workmux add` from the matched repository for a new issue or pull
